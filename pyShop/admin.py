...
class Admin_Page:
    def __init__(self, top=None):
        ...
        self.button2.place(relx=0.463, rely=0.885, width=80, height=20)
        ...
        self.button2.configure(font="-family {Arista Pro Alternate Bold} -size 13")
        self.button2.configure(borderwidth="0")
        self.button2.configure(text="""Enter""")
        self.button2.configure(command=inventory)

        self.button3 = Button(adm)
        self.button3.place(relx=0.463, rely=0.580, width=80, height=20)
        ...
        self.button3.configure(font="-family {Arista Pro Alternate Bold} -size 13")
        ...
        self.button4.place(relx=0.463, rely=0.280, width=80, height=20)        
        ...
        self.button4.configure(font="-family {Arista Pro Alternate Bold} -size 13")
...
class Employee:
    def __init__(self, top=None):
        ...
        self.entry1.configure(background="#a7bcdb")
        ...
        self.button1.configure(background="#67a4ff")
        self.button1.configure(font="-family {Arista Pro Alternate Bold} -size 14")
        self.button1.configure(borderwidth="0")
        self.button1.configure(text="""Search""")
        self.button1.configure(command=self.search_emp)

        self.button3 = Button(emp)
        self.button3.place(relx=0.100, rely=0.432, width=200, height=28)
        self.button3.configure(relief="flat")
        self.button3.configure(overrelief="flat")
        self.button3.configure(activebackground="#CF1E14")
        self.button3.configure(cursor="hand2")
        self.button3.configure(foreground="white")
        self.button3.configure(background="#39b54a")
        self.button3.configure(font="-family {Arista Pro Alternate Bold} -size 14")
        self.button3.configure(borderwidth="0")
        ...
        self.button4.place(relx=0.100, rely=0.525, width=200, height=28)
        self.button4.configure(relief="flat")
        self.button4.configure(overrelief="flat")
        self.button4.configure(activebackground="#CF1E14")
        self.button4.configure(cursor="hand2")
        self.button4.configure(foreground="white")
        self.button4.configure(background="#67a4ff")
        self.button4.configure(font="-family {Arista Pro Alternate Bold} -size 14")
        self.button4.configure(borderwidth="0")
        self.button4.configure(text="""UPDATE EMPLOYEE""")
        self.button4.configure(command=self.update_emp)

        self.button5 = Button(emp)
        self.button5.place(relx=0.100, rely=0.605, width=200, height=28)
        ...
        self.button5.configure(background="#e44047")
        self.button5.configure(font="-family {Arista Pro Alternate Bold} -size 14")
        self.button5.configure(borderwidth="0")
        self.button5.configure(text="""DELETE EMPLOYEE""")
        self.button5.configure(command=self.delete_emp)

        self.button6 = Button(emp)
        self.button6.place(relx=0.100, rely=0.680, width=200, height=28)
        self.button6.configure(relief="flat")
        self.button6.configure(overrelief="flat")
        self.button6.configure(activebackground="#CF1E14")
        self.button6.configure(cursor="hand2")
        self.button6.configure(foreground="white")
        self.button6.configure(background="#6f5fc0")
        self.button6.configure(font="-family {Arista Pro Alternate Bold} -size 14")
...
class Inventory:
    def __init__(self, top=None):
        ...
        self.button1.configure(foreground="#ffffff")
        self.button1.configure(background="#67a4ff")
        self.button1.configure(font="-family {Arista Pro Alternate Bold} -size 12")
        self.button1.configure(borderwidth="0")
        self.button1.configure(text="""Search""")
...
class add_product:
    def __init__(self, top=None):
        ...
        self.entry1.configure(background="#ddf0fa")
        self.entry1.configure(font="-family {Poppins} -size 12")
        self.entry1.configure(relief="flat")

        self.entry2 = Entry(p_add)
        self.entry2.place(relx=0.132, rely=0.413, width=374, height=30)
        self.entry2.configure(background="#ddf0fa")
        self.entry2.configure(font="-family {Poppins} -size 12")
        self.entry2.configure(relief="flat")
        ...
        self.entry3.place(relx=0.132, rely=0.529, width=374, height=30)
        self.entry3.configure(background="#ddf0fa")
        self.entry3.configure(font="-family {Poppins} -size 12")
        self.entry3.configure(relief="flat")
        ...
        self.entry6.configure(background="#ddf0fa")
        self.entry6.configure(font="-family {Poppins} -size 12")
        self.entry6.configure(relief="flat")
        ...
        self.entry7.configure(background="#ddf0fa")
        ...
        self.entry8.configure(background="#ddf0fa")
...
class Update_Product:
    def __init__(self, top=None):
        ...
        self.entry4.place(relx=0.132, rely=0.646, width=374, height=30)
        self.entry4.configure(background="#ddf0fa")
        self.entry4.configure(font="-family {Poppins} -size 12")
        self.entry4.configure(relief="flat")
...
class Invoice:
    def __init__(self, top=None):
        ...
        self.button3.place(relx=0.100, rely=0.380, width=200, height=28)
        self.button3.configure(relief="flat")
        self.button3.configure(overrelief="flat")
        self.button3.configure(activebackground="#CF1E14")
        self.button3.configure(cursor="hand2")
        self.button3.configure(foreground="white")
        self.button3.configure(background="#e44047")
        self.button3.configure(font="-family {Arista Pro Alternate Bold} -size 14")
        self.button3.configure(borderwidth="0")
        ...
        self.button4.place(relx=0.100, rely=0.480, width=200, height=28)
        self.button4.configure(relief="flat")
        self.button4.configure(overrelief="flat")
        self.button4.configure(activebackground="#CF1E14")
        self.button4.configure(cursor="hand2")
        self.button4.configure(foreground="white")
        self.button4.configure(background="#6f5fc0")
        self.button4.configure(font="-family {Arista Pro Alternate Bold} -size 14")
        self.button4.configure(borderwidth="0")
