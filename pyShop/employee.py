...
class login_page:
    def __init__(self, top=None):
        top.geometry("1366x768")# login Form size
        top.resizable(0, 0)
        ...
        self.entry1.place(relx=0.619, rely=0.352, width=374, height=30)
        self.entry1.configure(font="-family {Arista Pro Alternate Bold} -size 10")
        self.entry1.configure(relief="flat")
        self.entry1.configure(textvariable=user)

        self.entry2 = Entry(root)
        self.entry2.place(relx=0.619, rely=0.454, width=374, height=30)
        self.entry2.configure(font="-family {Arista Pro Alternate Bold} -size 10")
        self.entry2.configure(relief="flat")
        self.entry2.configure(show="*")
        self.entry2.configure(textvariable=passwd)

        self.button1 = Button(root)
        self.button1.place(relx=0.645, rely=0.565, width=270, height=35)
        self.button1.configure(relief="flat")
        self.button1.configure(overrelief="flat")
        self.button1.configure(activebackground="#67a4ff")
        self.button1.configure(cursor="hand2")
        self.button1.configure(foreground="#ffffff")
        self.button1.configure(background="#67a4ff")
        self.button1.configure(font="-family {Arista Pro Alternate Bold} -size 20")
...
class bill_window:
    def __init__(self, top=None):
        top.geometry("1366x768") # main window size 
        top.resizable(0, 0)
        ...
        self.entry1.place(relx=0.460, rely=0.187, width=170, height=30)
        self.entry1.configure(background="#d8e1ff")
        self.entry1.configure(font="-family {Poppins} -size 12")
        self.entry1.configure(relief="flat")
        self.entry1.configure(textvariable=cust_name)

        self.entry2 = Entry(biller)
        self.entry2.place(relx=0.805, rely=0.187, width=165, height=30)
        self.entry2.configure(background="#d8e1ff")
        self.entry2.configure(font="-family {Poppins} -size 12")
        self.entry2.configure(relief="flat")
        self.entry2.configure(textvariable=cust_num)

        self.entry3 = Entry(biller)
        self.entry3.place(relx=0.16, rely=0.187, width=170, height=30)
        self.entry3.configure(font="-family {Poppins} -size 12")
        self.entry3.configure(relief="flat")
        self.entry3.configure(background="#d8e1ff")
        self.entry3.configure(textvariable=cust_search_bill)

        self.button2 = Button(biller)
        self.button2.place(relx=0.305, rely=0.230, width=76, height=23)
        self.button2.configure(relief="flat")
        self.button2.configure(overrelief="flat")
        self.button2.configure(activebackground="#ffdc5f")
        self.button2.configure(cursor="hand2")
        self.button2.configure(foreground="#ffffff")
        self.button2.configure(background="#ffdc5f")
        self.button2.configure(font="-family {Arista Pro Alternate Bold} -size 10")
        ...
        self.button3.place(relx=0.410, rely=0.312, width=150, height=26)
        self.button3.configure(relief="flat")
        self.button3.configure(overrelief="flat")
        self.button3.configure(activebackground="#d8e1ff")
        self.button3.configure(cursor="hand2")
        self.button3.configure(foreground="#4b4b4b")
        self.button3.configure(background="#d8e1ff")
        self.button3.configure(font="-family {Arista Pro Alternate Bold} -size 25")
        self.button3.configure(borderwidth="0")
        self.button3.configure(text="""Compute""")
        self.button3.configure(command=self.total_bill)

        self.button4 = Button(biller)
        self.button4.place(relx=0.695, rely=0.312, width=150, height=26)
        self.button4.configure(relief="flat")
        self.button4.configure(overrelief="flat")
        self.button4.configure(activebackground="#d8e1ff")
        self.button4.configure(cursor="hand2")
        self.button4.configure(foreground="#4b4b4b")
        self.button4.configure(background="#d8e1ff")
        self.button4.configure(font="-family {Arista Pro Alternate Bold} -size 25")
        ...
        self.button6.place(relx=0.05, rely=0.09, width=86, height=25)
        ...
        self.button6.configure(font="-family {Arista Pro Alternate Bold} -size 10")
        self.button6.configure(borderwidth="0")
        self.button6.configure(text="""Exit""")
        self.button6.configure(command=exitt)

        self.button7 = Button(biller)
        self.button7.place(relx=0.060, rely=0.930, width=86, height=26)
        ...
        self.button7.configure(background="#2ecc71")
        self.button7.configure(font="-family {Arista Pro Alternate Bold} -size 10")
        ...
        self.button8.place(relx=0.260, rely=0.930, width=84, height=26)
        ...
        self.button8.configure(background="#d07a2b")
        self.button8.configure(font="-family {Arista Pro Alternate Bold} -size 10")
        ...
        self.button9.place(relx=0.163, rely=0.930, width=84, height=26)
        ...
        self.button9.configure(background="#cc3e3e")
        self.button9.configure(font="-family {Arista Pro Alternate Bold} -size 10")
        ...
        self.combo1.place(relx=0.13, rely=0.350, width=300, height=30)
        ...
        self.combo2.place(relx=0.168, rely=0.475, width=250, height=30)
        ...
        self.combo3.place(relx=0.13, rely=0.600, width=300, height=30)
        ...
        self.entry4.place(relx=0.13, rely=0.730, width=300, height=30)
    ...
    def show_qty(self, Event):
        ...
        self.qty_label.place(relx=0.127, rely=0.640, width=82, height=26)
        self.qty_label.configure(font="-family {Arial} -size 10")
        ...
        self.qty_label.configure(background="#d8e1ff")
    ...
    def wel_bill(self):
        ...
        self.name_message.configure(background="#d8e1ff")
        ...
        self.num_message.configure(background="#d8e1ff")
        ...
        self.bill_message.configure(background="#d8e1ff")
        ...
        self.bill_date_message.configure(background="#d8e1ff")  
    ...
    def total_bill(self):
        if self.cart.isEmpty():
            ...
            if strr.find('Total')==-1:
                ...
                total = "\nTotal\t\t\t\t\t\t\t\t\t\t\tPHP. {}".format(self.cart.total())
        ...
        if self.state == 1:
            ...
            if(cust_name.get()==""):
                ...
                if strr.find('Total')==-1:
                    ...
                    self.entry1.configure(state="disabled", disabledbackground="#d8e1ff", disabledforeground="#d8e1ff")
                    self.entry2.configure(state="disabled", disabledbackground="#d8e1ff", disabledforeground="#d8e1ff")
                    self.state = 0
        else:
            return
